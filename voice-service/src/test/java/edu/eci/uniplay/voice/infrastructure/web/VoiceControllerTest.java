...
class VoiceControllerTest {
    ...
    void createsVoiceToken() throws Exception {
        ...
        MockMvc mockMvc = MockMvcBuilders.standaloneSetup(new VoiceController(useCase))
    ...
    void rejectsInvalidRequestBody() throws Exception {
        MockMvc mockMvc = MockMvcBuilders.standaloneSetup(new VoiceController(mock(GenerateVoiceTokenUseCase.class)))
                .setControllerAdvice(new GlobalExceptionHandler())
                .build();
